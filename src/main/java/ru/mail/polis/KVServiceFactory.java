...
import ru.mail.polis.lizasold.MyDAO;
import ru.mail.polis.lizasold.MyFileDAO;
import ru.mail.polis.lizasold.MyService;
...
final class KVServiceFactory {
    ...
    static KVService create(
        ...
        return new MyService(port, new MyFileDAO(data), topology);
    }
}
